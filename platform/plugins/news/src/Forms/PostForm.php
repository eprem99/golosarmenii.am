...
use Botble\News\Forms\Fields\CategoryMultiField;
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('categories[]', 'categoryMulti', [
                'label'      => trans('plugins/news::posts.form.categories'),
                'label_attr' => ['class' => 'control-label required'],
            ...
            ->add('tag', 'tags', [
                'label'      => trans('plugins/news::posts.form.tags'),
                'label_attr' => ['class' => 'control-label'],
                'value'      => $tags,
                'attr' => [
                    'placeholder' => trans('plugins/news::base.write_some_tags'),
