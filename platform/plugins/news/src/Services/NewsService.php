        ...
        switch ($slug->reference_type) {
            case Post::class:
                ...
                if (function_exists('admin_bar') && Auth::check() && Auth::user()->hasPermission('posts.edit')) {
                    admin_bar()->registerLink(trans('plugins/news::posts.edit_this_post'),
            ...
            case Category::class:
                ...
                if (function_exists('admin_bar') && Auth::check() && Auth::user()->hasPermission('categories.edit')) {
                    admin_bar()->registerLink(trans('plugins/news::categories.edit_this_category'),
            ...
            case Tag::class:
                ...
                if (function_exists('admin_bar') && Auth::check() && Auth::user()->hasPermission('tags.edit')) {
                    admin_bar()->registerLink(trans('plugins/news::tags.edit_this_tag'), route('tags.edit', $tag->id));
                }
                ...
                return [
                    'view'         => 'tag',
                    'default_view' => 'plugins/news::themes.tag',
