...
class PublicController extends Controller
{
     ...
     */
    public function getTag($slug, NewsService $newsService)
    {
        ...
        $data = $newsService->handleFrontRoutes($slug);
     ...
     * @return \Illuminate\Http\RedirectResponse|Response
     */
    public function getPost($slug, NewsService $newsService)
    {
     ...
     * @return \Illuminate\Http\RedirectResponse|Response
     */
    public function getCategory($slug, NewsService $newsService)
    {
