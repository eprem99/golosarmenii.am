...
use Botble\News\Tables\CategoryTable;
...
class CategoryController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/news::categories.menu'));
    ...
    {
        page_title()->setTitle(trans('plugins/news::categories.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/news::categories.edit') . ' "' . $category->name . '"');
