...
class TagController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/news::tags.menu'));
    ...
    {
        page_title()->setTitle(trans('plugins/news::tags.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/news::tags.edit') . ' "' . $tag->name . '"');
    ...
    public function destroy($id, Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            return $response->setMessage(trans('plugins/news::tags.deleted'));
        } catch (Exception $exception) {
            return $response
                ->setError()
                ->setMessage(trans('plugins/news::tags.cannot_delete'));
        }
    }
