...
use Botble\News\Services\StoreCategoryService;
use Botble\News\Services\StoreTagService;
use Exception;
...
class PostController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/news::posts.menu_name'));
    ...
    {
        page_title()->setTitle(trans('plugins/news::posts.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/news::posts.edit') . ' "' . $post->name . '"');
    ...
    public function getWidgetRecentPosts(Request $request, BaseHttpResponse $response)
    {
        ...
        return $response
            ->setData(view('plugins/news::posts.widgets.posts', compact('posts', 'limit'))->render());
    }
}
