                                ...
                                <tr>
                                    <td align="left" style="padding: 20px 50px;">
                                        ...
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/person.png"
                                                alt="From" width="20" style="margin-right: 10px;" /> {{ subscribe_name }}</p>
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/edit.png"
                                                alt="Subject" width="20" style="margin-right: 10px;" /> {{ subscribe_subject }}</p>
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/email.png"
                                                alt="Email" width="20" style="margin-right: 10px;" /> {{ subscribe_email }}</p>
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/map.png"
                                                alt="Address" width="20" style="margin-right: 10px;" /> {{ subscribe_address }}</p>
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/phone.png"
                                                alt="Phone" width="20" style="margin-right: 10px;" /> {{ subscribe_phone }}</p>
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/message.png"
                                                alt="Message" width="20" style="margin-right: 10px;" /> {{ subscribe_content }}</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        <td class="column" align="center">
                            <table>
                                ...
                                <tr>
                                    <td align="center">
                                        <p>You can reply an email to {{ subscribe_email }} by clicking on below button.</p> <br />
                                        <a href="mailto:{{ subscribe_email }}" class="action-button">Answer</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
