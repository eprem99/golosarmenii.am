...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function sendUsingTemplate($template, $email = null, $args = [], $debug = false, $type = 'plugins')
        {
                        /** @var \Botble\Base\Supports\EmailHandler $instance */
                        return $instance->sendUsingTemplate($template, $email, $args, $debug, $type);
        }
                    /**
         * 
         *
